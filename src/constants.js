...
exports = {
    ...
    AWARDS: {
        ...
        'wool.10': { text: 'Collect 10 bolts of wool', reward: 20 },
        'wool.100': { text: 'Collect 100 bolts of wool', reward: 40 },
        'wool.1000': { text: 'Collect 1000 bolts of wool', reward: 60 },
        'wool.10000': { text: 'Collect 10000 bolts of wool', reward: 80 },
        'wool.100000': { text: 'Collect 100000 bolts of wool', reward: 100 },

        'wool.white.2': { text: 'Collect 2 bolts of white wool', reward: 20 },
        'wool.white.20': { text: 'Collect 20 bolts of white wool', reward: 40 },
        'wool.white.200': { text: 'Collect 200 bolts of white wool', reward: 60 },
        'wool.white.2000': { text: 'Collect 2000 bolts of white wool', reward: 80 },
        'wool.white.20000': { text: 'Collect 20000 bolts of white wool', reward: 100 },

        'wool.red.2': { text: 'Collect 2 bolts of red wool', reward: 20 },
        'wool.red.20': { text: 'Collect 20 bolts of red wool', reward: 40 },
        'wool.red.200': { text: 'Collect 200 bolts of red wool', reward: 60 },
        'wool.red.2000': { text: 'Collect 2000 bolts of red wool', reward: 80 },
        'wool.red.20000': { text: 'Collect 20000 bolts of red wool', reward: 100 },

        'wool.blue.2': { text: 'Collect 2 bolts of blue wool', reward: 20 },
        'wool.blue.20': { text: 'Collect 20 bolts of blue wool', reward: 40 },
        'wool.blue.200': { text: 'Collect 200 bolts of blue wool', reward: 60 },
        'wool.blue.2000': { text: 'Collect 2000 bolts of blue wool', reward: 80 },
        'wool.blue.20000': { text: 'Collect 20000 bolts of blue wool', reward: 100 },

        'wool.yellow.2': { text: 'Collect 2 bolts of yellow wool', reward: 20 },
        'wool.yellow.20': { text: 'Collect 20 bolts of yellow wool', reward: 40 },
        'wool.yellow.200': { text: 'Collect 200 bolts of yellow wool', reward: 60 },
        'wool.yellow.2000': { text: 'Collect 2000 bolts of yellow wool', reward: 80 },
        'wool.yellow.20000': { text: 'Collect 20000 bolts of yellow wool', reward: 100 },

        'wool.black.2': { text: 'Collect 2 bolts of black wool', reward: 20 },
        'wool.black.20': { text: 'Collect 20 bolts of black wool', reward: 40 },
        'wool.black.200': { text: 'Collect 200 bolts of black wool', reward: 60 },
        'wool.black.2000': { text: 'Collect 2000 bolts of black wool', reward: 80 },
        'wool.black.20000': { text: 'Collect 20000 bolts of black wool', reward: 100 },

        'crafts.hats': { text: 'Craft all hats', reward: 20 },
        'crafts.mittens': { text: 'Craft all mittens', reward: 40 },
        'crafts.socks': { text: 'Craft all socks', reward: 60 },
        'crafts.scarves': { text: 'Craft all scarves', reward: 80 },
        'crafts.sweaters': { text: 'Craft all sweaters', reward: 100 },
        'crafts.white': { text: 'Craft all white items', reward: 120 },
        'crafts.red': { text: 'Craft all red items', reward: 120 },
        'crafts.blue': { text: 'Craft all blue items', reward: 120 },
        'crafts.yellow': { text: 'Craft all yellow items', reward: 120 },
        'crafts.black': { text: 'Craft all black items', reward: 120 },
        'crafts.all': { text: 'Craft all items', reward: 140 }
    }
};
